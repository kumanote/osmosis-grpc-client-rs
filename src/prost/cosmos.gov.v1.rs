...
pub mod msg_client {
    ...
    use tonic::codegen::*;
    #[doc = " Msg defines the gov Msg service."]
    #[derive(Debug, Clone)]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " ExecLegacyContent defines a Msg to be in included in a MsgSubmitProposal"]
        #[doc = " to execute a legacy content-based proposal."]
