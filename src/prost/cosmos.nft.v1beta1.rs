...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Send defines a method to send a nft from one account to another account."]
        pub async fn send(
            &mut self,
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        #[doc = " Balance queries the number of NFTs of a given class owned by the owner, same as balanceOf in ERC721"]
        ...
        #[doc = " Owner queries the owner of the NFT based on its class and id, same as ownerOf in ERC721"]
        pub async fn owner(
            &mut self,
        ...
        #[doc = " Supply queries the number of NFTs from the given class, same as totalSupply of ERC721."]
        pub async fn supply(
            &mut self,
        ...
        #[doc = " NFTs queries all NFTs of a given class or owner,choose at least one of the two, similar to tokenByIndex in"]
        #[doc = " ERC721Enumerable"]
        pub async fn nf_ts(
            &mut self,
        ...
        #[doc = " NFT queries an NFT based on its class and id."]
        pub async fn nft(
            &mut self,
        ...
        #[doc = " Class queries an NFT class based on its id"]
        pub async fn class(
            &mut self,
        ...
        #[doc = " Classes queries all NFT classes"]
