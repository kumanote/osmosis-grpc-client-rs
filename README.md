...
- see [osmosis/go.mod at v12.2.0 · osmosis-labs/osmosis](https://github.com/osmosis-labs/osmosis/blob/v12.2.0/go.mod) for listing related
packages versions.
- and also [cosmos-sdk/go.mod at v0.46.1](https://github.com/cosmos/cosmos-sdk/blob/v0.46.1/go.mod)

---

- [osmosis/proto/osmosis at v12.2.0](https://github.com/osmosis-labs/osmosis/tree/v12.2.0/proto/osmosis)
